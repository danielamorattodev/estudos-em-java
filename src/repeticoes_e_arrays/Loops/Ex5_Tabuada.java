...
...
5 X 10 = 50
- Exercicio para estudo do laço "for";
*/
...
public class Ex5_Tabuada {
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= 10; i++){
            System.out.println(tabuada + " X " + i + "=" + (tabuada*i)); //número escolhido pelo usuário "X" o valor de i "=" a multiplicação do número com o i.
        }
